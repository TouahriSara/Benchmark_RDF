...
stats_file = "/home/adminlias/data/PFE_/generated_files/query_vector_LUBM_20250314_101048.csv"                # Contient : Requête, SELECT(n), JOIN(n), FILTER(1ou 0), UNION(n ou 0), ORDER BY(1ou 0), GROUP BY(1ou 0), LIMIT/OFFSET(1ou 0)
output_filename = "merged_LUBM_virtuoso_withbuffer.csv"           # Fichier final à générer
