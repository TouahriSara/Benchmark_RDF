...
power_log_file = f'power_log_LUBM_virtuoso_{timestamp}.csv'
query_time_log = f'query_time_log_LUBM_virtuoso_{timestamp}.csv'
...
if __name__ == '__main__':
    ...
    q_file_path = '/home/adminlias/data/ddd/Downloads/rdf-exp-master/queries/workloads/lubm10240/string/workload_10k/all_batch_sequential.q'
