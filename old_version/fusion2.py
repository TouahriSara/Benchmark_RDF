...
powerlog_file = "/home/adminlias/data/PFE_/generated_files/power_log_LUBM_virtuoso_withbuffer_20250312_095432.csv"  # Contient : query, execution_time_s, puissance_moyenne_W, energy_consumed_J
stats_file = "/home/adminlias/data/PFE_/generated_files/query_vector_LUBM_20250312_110940.csv"         # Contient : Requête, SELECT(n), JOIN(n), FILTER(1ou 0), UNION(n ou 0), ORDER BY(1ou 0), GROUP BY(1ou 0), LIMIT/OFFSET(1ou 0)
output_filename = "merged_LUBM_virtuoso_withbuffer.sql"  # Fichier SQL final à générer
